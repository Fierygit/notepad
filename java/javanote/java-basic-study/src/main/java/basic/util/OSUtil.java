...
public final class OSUtil {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(newRuntimeInfo());
        System.out.println("name: " + getName());
        System.out.println("cpu_num: " + OSUtil.getNumberOfCpus());
        System.out.println("arch: " + OSUtil.getArch());
        System.out.println("VirtualMem: " + OSUtil.getCommittedVirtualMemorySize()/1024/1024 + " MB");
        System.out.println("PhysicalMem: " + OSUtil.getFreePhysicalMemorySize()/1024/1024 + " MB");
