...
class Gzh_wz(object):
    def __init__(self):
        ...
        self.url_dict = {
            '丁香医生': 'https://mp.weixin.qq.com/cgi-bin/appmsg?action=list_ex&begin=0&count=5&fakeid=MjA1ODMxMDQwMQ==&type=9&query=&token=2038324144&lang=zh_CN&f=json&ajax=1',
